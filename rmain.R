...
setwd("C:/Users/dell/Desktop/r语言代码版本")
...
# Display the results
print("clr")
cat("clr Mean ARI:", mean_ari, "\n")
cat("clr Variance ARI:", var_ari, "\n")
cat("clr Mean RMSE:", mean_rmse, "\n")
cat("clr Variance RMSE:", var_rmse, "\n")
cat("clr Mean PRE:", mean_pre, "\n")
cat("clr Variance PRE:", var_pre, "\n")
...
# Display the results
print("kmeans")
cat("kmeans Mean ARI:", mean_ari, "\n")
cat("kmeans Variance ARI:", var_ari, "\n")
cat("kmeans Mean RMSE:", mean_rmse, "\n")
cat("kmeans Variance RMSE:", var_rmse, "\n")
cat("kmeans Mean PRE:", mean_pre, "\n")
cat("kmeans Variance PRE:", var_pre, "\n")
...
for(gamma in c(0.1,1,10)){
  ...
  print("kplane")
  cat("gamma:", gamma, "\n")
  cat("kplane Mean ARI:", mean_ari, "\n")
  cat("kplane Variance ARI:", var_ari, "\n")
  cat("kplane Mean RMSE:", mean_rmse, "\n")
  cat("kplane Variance RMSE:", var_rmse, "\n")
  cat("kplane Mean PRE:", mean_pre, "\n") 
  cat("kplane Variance PRE:", var_pre, "\n")
}
